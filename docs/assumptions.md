...
- The implementation will choose the simplest Python dependency workflow that satisfies the specs; `uv` and `pip-tools` remain candidates.
...
- Whether the final persistence library is SQLModel or SQLAlchemy.
